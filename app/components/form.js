  ...
  return (
    <div className='bg-white p-5 rounded-2xl h-[85vh] w-full relative'>
      <form>
        ...
        <button type="button" onClick={extract} className="md:absolute bottom-5 right-5 mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Preview</button>
      </form>
    </div>
  );
}
